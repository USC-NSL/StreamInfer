#!/usr/bin/bash
# Test run: 1 node, 2 GPUs, 8 layers, FP8 attention + FP8 experts + 2 shared experts
# Validates shared expert support (CUTLASS SM89)
# Run on sgpu5 (NVIDIA L40S) with conda env disag12
